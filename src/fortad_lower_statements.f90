...
contains
    ...
    subroutine validate_component_reference(arena, idx, status, &
        ...
        !! scalar through rank-four REAL component accesses of a concrete,
        ...
        if (allow_lifetime_owner .and. component_rank > 4) then
            call refuse_component(arena, idx, &
                "component lifetime requires a scalar through rank-four concrete REAL "// &
