...
candidate files: 55 runnable pure-Fortran cases, 126 deliberate refusals, 28
invalid-upstream closures, 1,297 queued candidates, and 508 non-Fortran or
source-absent cases. The complete compiler-only triage covers all 1,297 queued
candidates (2,015 accepted files, 1,420 compiler diagnostics, and 147 include
