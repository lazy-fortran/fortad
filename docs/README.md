...
| [Polymorphic ownership](design/polymorphic-ownership.md) | passive fixed-type allocatable dispatch and semantic refusal for active polymorphic ownership | [`test_polymorphic_ownership_oracle.f90`](../test/test_polymorphic_ownership_oracle.f90) |
